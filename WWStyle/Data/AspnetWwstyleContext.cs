...
public partial class AspnetWwstyleContext : DbContext
{
    public AspnetWwstyleContext()
    {
    }

    public AspnetWwstyleContext(DbContextOptions<AspnetWwstyleContext> options)
        : base(options)
    {
    }
